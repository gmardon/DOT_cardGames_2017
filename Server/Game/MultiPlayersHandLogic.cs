...
{
    internal class MultiPlayersHandLogic : IHandLogic
    {
        ...
        private readonly MultiPlayersBettingLogic bettingLogic;

        private Dictionary<string, ICollection<Card>> showdownCards;

        public MultiPlayersHandLogic(IList<InternalPlayer> players, int handNumber, int smallBlind)
        {
